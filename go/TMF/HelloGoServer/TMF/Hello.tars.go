...
func (_obj *Hello) AddWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *Hello) AddOneWayWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *Hello) GetStringSize(content string, size *int32, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(tarsCtx, 0, "GetStringSize", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
func (_obj *Hello) GetStringSizeWithContext(tarsCtx context.Context, content string, size *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *Hello) GetStringSizeOneWayWithContext(tarsCtx context.Context, content string, size *int32, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(tarsCtx, 1, "GetStringSize", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
type _impHelloWithContext interface {
	...
	GetStringSize(tarsCtx context.Context, content string, size *int32) (ret int32, err error)
}
...
func (_obj *Hello) Dispatch(tarsCtx context.Context, _val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, _withContext bool) (err error) {
	...
	case "GetStringSize":
		...
		if tarsReq.IVersion == basef.TARSVERSION {
			...
			_reqTup_.GetBuffer("content", &_tupBuffer_)
			_is.Reset(_tupBuffer_)
			err = _is.Read_string(&content, 0, true)
			if err != nil {
				return err
			}
			...
			err = json.Unmarshal(_is.ToBytes(), &_jsonDat_)
			{
				_jsonStr_, _ := json.Marshal(_jsonDat_["content"])
				if err = json.Unmarshal([]byte(_jsonStr_), &content); err != nil {
					return err
				}
			}
		...
		if _withContext == false {
			_imp := _val.(_impHello)
			_funRet_, err = _imp.GetStringSize(content, &size)
		} else {
			_imp := _val.(_impHelloWithContext)
			_funRet_, err = _imp.GetStringSize(tarsCtx, content, &size)
		}
		...
		if tarsReq.IVersion == basef.TARSVERSION {
			...
			_os.Reset()
			err = _os.Write_int32(size, 0)
			if err != nil {
				return err
			}

			_tupRsp_.PutBuffer("size", _os.ToBytes())
